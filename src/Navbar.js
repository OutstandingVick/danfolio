...
const Navbar = () => {
  return (
    <div className='overflow-hidden bg-rich flex justify-center'>
      <nav className='fixed w-full h-24 flex justify-between items-center p-4 bg-rich text-lime-400 font-bold'>
        <div className='no-underline p-2 pl-4 lg:pl-60 text-base md:text-2xl hover:text-alice font-tilt'>
          DANIEL
        </div>

        <div className='hidden md:flex space-x-8 font-tilt text-2xl pr-60'>
          <a href='/' className='no-underline hover:text-alice'>
            HOME
          </a>
          <a href='/work' className='no-underline hover:text-alice'>
            PROOF OF WORK
          </a>
          <a href='/about' className='no-underline hover:text-alice'>
            ABOUT
          </a>
        </div>
